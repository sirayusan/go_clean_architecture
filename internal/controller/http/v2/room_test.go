...
func (m *RoomUseCaseMock) GetChats(userID uint32) (entity.ChatRooms, error) {
...
func createDataChatMessage(conn *pkgmysql.MySQL, t *testing.T) {
	var err error
	userList := []model.User{
		{
			UserID:            1,
