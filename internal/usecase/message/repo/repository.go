...
// GetMessageList はチャットリストを取得します。
func (r *ChatRepository) GetMessageList(userID uint32) (entity.Messages, error) {
	...
	if len(chatList) == 0 {
		return entity.Messages{}, gorm.ErrRecordNotFound
	}

	return entity.Messages{}, nil
}
